...
if ($login == "" || $login == null) {
    echo"<script language='javascript' type='text/javascript'>alert('O campo login deve ser preenchido BIZONHO');window.location.href='cadastro.html';</script>";
} else {
    if ($logarray == $login) {
        ...
        if ($insert) {
            ...
            echo"<script language='javascript' type='text/javascript'>alert('Nao foi possivel cadastrar');window.location.href='cadastro.html'</script>";
        }
    }
}
?>
